...
try {
    ...
    #$postParams = @{ org_id="123"; device_id="123"; signal=0 }
    #Invoke-WebRequest -Uri "http://$($dockerMachineIp):8080/v1/teltonikagateway/send_signal" -Method POST -Body $postParams
